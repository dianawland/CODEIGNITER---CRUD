...
<div id="container">
	<h1>Penerimaan Mahasiswa Baru STMIK Pelita Nusantara</h1>
...
<div id="container">
    ...
    <table border="1" style="border-collapse:collapse; width:67%">
    <tr>
            <th>id</th>
            <th>Nama</th>
            <th>TTL</th>
...
<a href ="<?php echo base_url()."index.php/crud/add_data";?>">tambahdata</a>
<td align ="center">
		<a href="<?php echo base_url()."index.php/crud/edit_data/" .$d['id']; ?>">Edit</a>
